...
class BookSearchWindow(QMainWindow):
    ...
    def init_ui(self):
        # Créer les widgets
        self.titleLabel = QLabel('Titre du livre:')
        ...
        self.setWindowTitle('Recherche de livre par titre')
    ...
    def search_book(self):
        ...
        for book in self.book_list:
            if book['titre'] == title:
                self.resultLabel.setText(f"Le livre {book['titre']} est disponible.")
                break
        else:
            self.resultLabel.setText(f"Le livre {title} n'a pas été trouvé.")
